...
# 이중 리스트 만들고 인덱싱하기
print()
arr.append([]) #[1, 2, 3, 4, 5, 10, 'hello', []]
arr[-1].append("korea") #[1, 2, 3, 4, 5, 10, 'hello', ['korea']]
print(arr)
print(arr[-1][0][2])  #r추출
print()
""" [ 연습 ] 아래에서
